(globalThis.TURBOPACK = globalThis.TURBOPACK || []).push(["static/chunks/src_f2b29f._.js", {
...
const theme = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$mui$2f$material$2f$styles$2f$createTheme$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__$3c$export__default__as__createTheme$3e$__["createTheme"])({
    palette: {
        ...
        custom: {
            black: {
                highEmphasis: '#B29584',
                mediumEmphasis: '#B29584',
                lowEmphasis: '#B29584',
                transparent: 'rgba(228, 20, 20, 0.1)'
            },
            white: {
                highEmphasis: '#B29584',
                mediumEmphasis: '#B29584',
...
"[project]/src/utils/languageNegotiator.ts [app-client] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_import__("[project]/node_modules/next/dist/compiled/react/index.js [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$navigation$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_import__("[project]/node_modules/next/navigation.js [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$languageNegotiator$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_import__("[project]/src/utils/languageNegotiator.ts [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$translations$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_import__("[project]/src/utils/translations.ts [app-client] (ecmascript)");
;
...
function LanguageProvider({ children }) {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "LanguageProvider.useEffect": ()=>{
            ...
            if (__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$languageNegotiator$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supportedLocales"].includes(urlLocale)) {
                setLocale(urlLocale);
            }
        }
    }["LanguageProvider.useEffect"], [
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "LanguageProvider.useEffect": ()=>{
            async function load() {
                const loadedTranslations = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$translations$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["loadTranslations"])(locale);
...
_s(LanguageProvider, "sa0RmMvTnm+hVh8n7e+vjaTKmdw=", false, function() {
    return [
...
"[project]/src/contexts/ResponsiveContext.tsx [app-client] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
'use client';
;
const ResponsiveContext = /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["createContext"])({
    isMobile: false,
    screenWidth: 0,
    setIsMobile: ()=>{},
    setScreenWidth: ()=>{}
...
function ResponsiveProvider({ children }) {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "ResponsiveProvider.useEffect": ()=>{
            const mediaQuery = window.matchMedia('(max-width: 768px)');
            const handleResize = {
                "ResponsiveProvider.useEffect.handleResize": (e)=>{
                    setIsMobile(e.matches);
                    setScreenWidth(window.innerWidth);
                }
            }["ResponsiveProvider.useEffect.handleResize"];
            handleResize(mediaQuery);
            mediaQuery.addEventListener('change', handleResize);
            // Initial screen width
            setScreenWidth(window.innerWidth);
            return ({
                "ResponsiveProvider.useEffect": ()=>mediaQuery.removeEventListener('change', handleResize)
            })["ResponsiveProvider.useEffect"];
        }
    }["ResponsiveProvider.useEffect"], []);
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(ResponsiveContext.Provider, {
        value: {
            isMobile,
            screenWidth,
            setIsMobile,
...
_s(ResponsiveProvider, "SNAnxy04G17O7hsQnaWMisGL1y0=");
_c = ResponsiveProvider;
function useResponsive() {
    _s1();
    return (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useContext"])(ResponsiveContext);
}
_s1(useResponsive, "gDsCjeeItUuvgOWf1v4qoK9RF6k=");
var _c;
__turbopack_refresh__.register(_c, "ResponsiveProvider");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_refresh__.registerExports(module, globalThis.$RefreshHelpers$);
}
}}),
...
_s1(useMenuOpen, "gDsCjeeItUuvgOWf1v4qoK9RF6k=");
var _c;
__turbopack_refresh__.register(_c, "MenuProvider");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_refresh__.registerExports(module, globalThis.$RefreshHelpers$);
}
}}),
"[project]/src/contexts/TabletContext.tsx [app-client] (ecmascript)": ((__turbopack_context__) => {
"use strict";

var { r: __turbopack_require__, f: __turbopack_module_context__, i: __turbopack_import__, s: __turbopack_esm__, v: __turbopack_export_value__, n: __turbopack_export_namespace__, c: __turbopack_cache__, M: __turbopack_modules__, l: __turbopack_load__, j: __turbopack_dynamic__, P: __turbopack_resolve_absolute_path__, U: __turbopack_relative_url__, R: __turbopack_resolve_module_id_path__, b: __turbopack_worker_blob_url__, g: global, __dirname, k: __turbopack_refresh__, m: module, z: __turbopack_require_stub__ } = __turbopack_context__;
{
__turbopack_esm__({
    "TabletProvider": (()=>TabletProvider),
    "useTablet": (()=>useTablet)
});
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_import__("[project]/node_modules/next/dist/compiled/react/jsx-dev-runtime.js [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_import__("[project]/node_modules/next/dist/compiled/react/index.js [app-client] (ecmascript)");
...
'use client';
;
const TabletContext = /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["createContext"])({
    isTablet: false,
    screenWidth: 0,
    setIsTablet: ()=>{},
    setScreenWidth: ()=>{}
});
function TabletProvider({ children }) {
    _s();
    ...
    const [screenWidth, setScreenWidth] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(0);
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "TabletProvider.useEffect": ()=>{
            const mediaQuery = window.matchMedia('(max-width: 980px)');
            const handleResize = {
                "TabletProvider.useEffect.handleResize": (e)=>{
                    setIsTablet(e.matches);
                    setScreenWidth(window.innerWidth);
                }
            }["TabletProvider.useEffect.handleResize"];
            handleResize(mediaQuery);
            mediaQuery.addEventListener('change', handleResize);
            // Initial screen width
            setScreenWidth(window.innerWidth);
            return ({
                "TabletProvider.useEffect": ()=>mediaQuery.removeEventListener('change', handleResize)
            })["TabletProvider.useEffect"];
        }
    }["TabletProvider.useEffect"], []);
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(TabletContext.Provider, {
        value: {
            isTablet,
            screenWidth,
            setIsTablet,
        ...
        fileName: "[project]/src/contexts/TabletContext.tsx",
        lineNumber: 42,
        columnNumber: 5
    }, this);
}
_s(TabletProvider, "4reovKwdZXzyz9iM9tmUTXtLT2U=");
_c = TabletProvider;
function useTablet() {
    _s1();
    return (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useContext"])(TabletContext);
}
_s1(useTablet, "gDsCjeeItUuvgOWf1v4qoK9RF6k=");
var _c;
__turbopack_refresh__.register(_c, "TabletProvider");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_refresh__.registerExports(module, globalThis.$RefreshHelpers$);
}
}}),
...
function Providers({ children }) {
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$ThemeRegistry$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"], {
        children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$mui$2f$material$2f$styles$2f$ThemeProvider$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__default__as__ThemeProvider$3e$__["ThemeProvider"], {
            ...
            children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$contexts$2f$TabletContext$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["TabletProvider"], {
                children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$contexts$2f$ResponsiveContext$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["ResponsiveProvider"], {
...
//# sourceMappingURL=src_f2b29f._.js.map