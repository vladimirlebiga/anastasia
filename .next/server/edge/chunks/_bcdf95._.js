(globalThis.TURBOPACK = globalThis.TURBOPACK || []).push(["chunks/_bcdf95._.js", {
...
const _parsepath = __turbopack_require__("[project]/node_modules/next/dist/shared/lib/router/utils/parse-path.js [middleware] (ecmascript)");
...
const _addpathprefix = __turbopack_require__("[project]/node_modules/next/dist/shared/lib/router/utils/add-path-prefix.js [middleware] (ecmascript)");
const _pathhasprefix = __turbopack_require__("[project]/node_modules/next/dist/shared/lib/router/utils/path-has-prefix.js [middleware] (ecmascript)");
...
const _removetrailingslash = __turbopack_require__("[project]/node_modules/next/dist/shared/lib/router/utils/remove-trailing-slash.js [middleware] (ecmascript)");
const _addpathprefix = __turbopack_require__("[project]/node_modules/next/dist/shared/lib/router/utils/add-path-prefix.js [middleware] (ecmascript)");
const _addpathsuffix = __turbopack_require__("[project]/node_modules/next/dist/shared/lib/router/utils/add-path-suffix.js [middleware] (ecmascript)");
const _addlocale = __turbopack_require__("[project]/node_modules/next/dist/shared/lib/router/utils/add-locale.js [middleware] (ecmascript)");
...
const _normalizelocalepath = __turbopack_require__("[project]/node_modules/next/dist/shared/lib/i18n/normalize-locale-path.js [middleware] (ecmascript)");
const _removepathprefix = __turbopack_require__("[project]/node_modules/next/dist/shared/lib/router/utils/remove-path-prefix.js [middleware] (ecmascript)");
const _pathhasprefix = __turbopack_require__("[project]/node_modules/next/dist/shared/lib/router/utils/path-has-prefix.js [middleware] (ecmascript)");
...
const _detectdomainlocale = __turbopack_require__("[project]/node_modules/next/dist/shared/lib/i18n/detect-domain-locale.js [middleware] (ecmascript)");
const _formatnextpathnameinfo = __turbopack_require__("[project]/node_modules/next/dist/shared/lib/router/utils/format-next-pathname-info.js [middleware] (ecmascript)");
const _gethostname = __turbopack_require__("[project]/node_modules/next/dist/shared/lib/get-hostname.js [middleware] (ecmascript)");
const _getnextpathnameinfo = __turbopack_require__("[project]/node_modules/next/dist/shared/lib/router/utils/get-next-pathname-info.js [middleware] (ecmascript)");
...
const _constants = __turbopack_require__("[project]/node_modules/next/dist/lib/constants.js [middleware] (ecmascript)");
...
const _nexturl = __turbopack_require__("[project]/node_modules/next/dist/server/web/next-url.js [middleware] (ecmascript)");
const _utils = __turbopack_require__("[project]/node_modules/next/dist/server/web/utils.js [middleware] (ecmascript)");
const _error = __turbopack_require__("[project]/node_modules/next/dist/server/web/error.js [middleware] (ecmascript)");
...
const _cookies1 = __turbopack_require__("[project]/node_modules/next/dist/server/web/spec-extension/cookies.js [middleware] (ecmascript)");
...
const _uaparserjs = /*#__PURE__*/ _interop_require_default(__turbopack_require__("[project]/node_modules/next/dist/compiled/ua-parser-js/ua-parser.js [middleware] (ecmascript)"));
...
0 && __export(__turbopack_require__("[project]/node_modules/next/dist/server/after/after.js [middleware] (ecmascript)"));
_export_star(__turbopack_require__("[project]/node_modules/next/dist/server/after/after.js [middleware] (ecmascript)"), exports);
...
"[project]/node_modules/next/dist/server/web/exports/index.js [middleware] (ecmascript)": (function(__turbopack_context__) {
...
const _imageresponse = __turbopack_require__("[project]/node_modules/next/dist/server/web/spec-extension/image-response.js [middleware] (ecmascript)");
const _request = __turbopack_require__("[project]/node_modules/next/dist/server/web/spec-extension/request.js [middleware] (ecmascript)");
const _response = __turbopack_require__("[project]/node_modules/next/dist/server/web/spec-extension/response.js [middleware] (ecmascript)");
const _useragent = __turbopack_require__("[project]/node_modules/next/dist/server/web/spec-extension/user-agent.js [middleware] (ecmascript)");
const _urlpattern = __turbopack_require__("[project]/node_modules/next/dist/server/web/spec-extension/url-pattern.js [middleware] (ecmascript)");
const _after = __turbopack_require__("[project]/node_modules/next/dist/server/after/index.js [middleware] (ecmascript)");
const _connection = __turbopack_require__("[project]/node_modules/next/dist/server/request/connection.js [middleware] (ecmascript)"); //# sourceMappingURL=index.js.map
}}),
"[project]/node_modules/next/dist/api/server.js [middleware] (ecmascript) <locals>": ((__turbopack_context__) => {
"use strict";
...
"[project]/node_modules/next/dist/api/server.js [middleware] (ecmascript) <module evaluation>": ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$api$2f$server$2e$js__$5b$middleware$5d$__$28$ecmascript$29$__$3c$locals$3e$__ = __turbopack_import__("[project]/node_modules/next/dist/api/server.js [middleware] (ecmascript) <locals>");
}}),
...
//# sourceMappingURL=_bcdf95._.js.map